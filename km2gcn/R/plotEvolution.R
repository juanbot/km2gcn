...
#' @param partitions The RDS partitions file as generated by \code{applykM2WGCNA}.
...
plotEvolution <- function(net.label,
                          net,
  ...
  if(!is.null(go.file))
    saveRDS(plotGOenrichment(net.label=net.label,
                             net=net,
                             partitions=partitions,
                             plot.file=NULL),go.file)
